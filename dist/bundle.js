...
/******/
/******/ 	// __webpack_hash__
/******/ 	__webpack_require__.h = "4432be1ffeae68d91255";
/******/
	    ...
	    _createClass(Main, [{
	        ...
	        value: function getRandPositionInMaze() {
	            ...
	            while (loop < 100) {
	                ...
	                var xBlock = this.rand(this.state.gameCanvas.mazeWidth, min);
	                var yBlock = this.rand(this.state.gameCanvas.mazeHeight, min);
